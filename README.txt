...
4. Run the api (npm run dev) and it should print to console "API listening on port 8080"
5. Run the app (npm run start) and the app should open up in your preferred browser. Enjoy!
